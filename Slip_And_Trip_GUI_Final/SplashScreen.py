...
################################################################################
## Form generated from reading UI file 'SplashScreennWAViA.ui'
##
...
"}")
        ...
        self.label_title_2.setGeometry(QRect(0, 170, 661, 61))
        font3 = QFont()
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"SLIP AND TRIP PLATFORM", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"loading...", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong> GUI Created by</strong>: Travis Bowen", None))
        self.label_title_2.setText(QCoreApplication.translate("SplashScreen", u"Team S.A.T.S", None))
    # retranslateUi
